    ...
    it('should return successful result with invalid cal proof (json)', done => {
      ...
      request(insecureServer)
        ...
        .end((err, res) => {
          ...
          expect(Object.keys(res.body[0].anchors[0]).length).to.equal(5)
          ...
          expect(res.body[0].anchors[0])
            ...
            .and.to.equal(false)
          expect(res.body[0].anchors[0])
            .to.have.property('block_id')
            .and.to.be.a('string')
            .and.to.equal('985635')
          expect(res.body[0].anchors[0])
            .to.have.property('block_value')
            .and.to.be.a('string')
            .and.to.not.equal('4690932f928fb7f7ce6e6c49ee95851742231709360be28b7ce2af7b92cfa95b')
          expect(res.body[0])
            .to.have.property('status')
            .and.to.be.a('string')
    ...
    it('should return successful result with invalid btc proof (json)', done => {
      ...
      request(insecureServer)
        ...
        .end((err, res) => {
          ...
          expect(Object.keys(res.body[0].anchors[1]).length).to.equal(5)
          ...
          expect(res.body[0].anchors[1])
            .to.have.property('block_value')
            .and.to.be.a('string')
            .and.to.not.equal('c617f5faca34474bea7020d75c39cb8427a32145f9646586ecb9184002131ad9')
          expect(res.body[0])
            .to.have.property('status')
            .and.to.be.a('string')
            .and.to.equal('invalid')
      ...
      request(insecureServer)
        ...
        .end((err, res) => {
          ...
          expect(res.body[0].anchors[0])
            .to.have.property('block_value')
            .and.to.be.a('string')
            .and.to.equal('4690932f928fb7f7ce6e6c49ee95851742231709360be28b7ce2af7b92cfa95b')
          expect(res.body[0])
            .to.have.property('status')
            .and.to.be.a('string')
      ...
      request(insecureServer)
        ...
        .end((err, res) => {
          ...
          expect(res.body[0].anchors[1])
            .to.have.property('block_value')
            .and.to.be.a('string')
            .and.to.equal('c617f5faca34474bea7020d75c39cb8427a32145f9646586ecb9184002131ad9')
          expect(res.body[0])
            .to.have.property('status')
            .and.to.be.a('string')
            .and.to.equal('verified')
