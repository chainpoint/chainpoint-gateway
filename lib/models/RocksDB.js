  ...
  for (let proofId of proofIds) {
    try {
      ...
      if (error.notFound) {
        ...
        let err = `Unable to read proof state for hash with hashIdNode = ${proofId} : ${error.message}`
        throw err
      }
    }
  }
...
module.exports = {
  ...
  getProofStatesBatchByHashIdNodesAsync: getProofStatesBatchByProofIdsAsync,
