...
let envDefinitions = {
  // Node Address
  CHAINPOINT_NODE_PUBLIC_SCHEME: envalid.str({ default: 'http', desc: 'The URI scheme of this Node' }),
  CHAINPOINT_NODE_PUBLIC_ADDR: envalid.str({ default: '127.0.0.1', desc: 'The URI address of this Node' }),
  CHAINPOINT_NODE_PORT: envalid.str({ default: '9090', desc: 'The URI port (listen address) of this Node' }),
  ...
  GET_CALENDAR_BLOCKS_MAX: envalid.num({ default: 1000, desc: 'The maximum number of calendar blocks retrieved in one request' }),
