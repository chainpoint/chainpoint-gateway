...
// function valETHPrivateKey(addr) {
//   if (!/^0x[0-9a-fA-F]{64}$/i.test(addr)) throw new Error('The Ethereum private key is invalid')
//   return addr.toLowerCase()
// }
...
// const validateETHPrivateKey = envalid.makeValidator(valETHPrivateKey)
...
let envDefinitions = {
  ...
  NODE_ETH_ADDRESS: envalid.str({
    desc: 'The Ethereum address for this Node, expects 0x address',
    example: '0x0000000000000000000000000000000000000000'
  }),

  NODE_ETH_PRIVATE_KEY: envalid.str({
    desc: 'The Ethereum private key for the preceding NODE_ETH_ADDRESS, expects 0x address',
    example: '0x0000000000000000000000000000000000000000'
  }),
