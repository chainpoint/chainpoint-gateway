...
async function getActiveUsageTokenAsync() {
  try {
    ...
    console.log(`INFO : Usage Token : Active token retrieved from storage with balance of ${balance} credit(s)`)
...
async function acquireNewUsageTokenAsync() {
  ...
  console.log(`INFO : Usage Token : New token acquired with ${env.AUTO_REFILL_AMOUNT} credit(s)`)
