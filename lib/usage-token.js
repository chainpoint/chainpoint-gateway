...
const tknDefinition = require('../eth-contracts/TierionNetworkToken.json')
...
function buildRawCreditTransaction(tokenAmount, gasPrice, nonce) {
  ...
  let functionInfo = contractInterface.functions.transfer
  let functionData = functionInfo.encode([burnAddress, tokenAmount])
