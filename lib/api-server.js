...
const apiKeys = require('./endpoints/keys.js')
...
async function restifyConfigureAndListenAsync (mergedIPList) {
  ...
  // Backup Auth Keys to .key.backup files written to /keys/backups direcotory
  server.post({ path: '/backup-auth-keys', version: '1.0.0' }, apiKeys.postBackupAuthKeysV1Async)
