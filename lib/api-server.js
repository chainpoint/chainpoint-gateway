...
server.get({ path: '/proofs/:hash_id_node', version: '1.0.0' }, apiProofs.getProofsByIDV1)
// get multiple proofs with 'hashids' header param
server.get({ path: '/proofs', version: '1.0.0' }, apiProofs.getProofsByIDV1)
...
server.get({ path: '/config', version: '1.0.0' }, apiConfig.getConfigInfoV1)
// teapot
