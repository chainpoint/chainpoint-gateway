...
async function restifyConfigureAndListenAsync (mergedIPList) {
  ...
  // Backup Auth Keys to .key.backup files written to chainpoint-node directory
  server.post({ path: '/backup-auth-keys', version: '1.0.0' }, apiConfig.postBackupAuthKeysV1Async)
