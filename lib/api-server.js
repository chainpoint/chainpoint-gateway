...
function setupCommonRestifyConfigAndRoutes(server) {
  ...
  server.get(
    ...
    apiReputation.getReputationDataByIdAsync
  )
  // get the most recent reputation items
  server.get(
    {
      path: '/reputation/recent',
      version: '2.0.0'
    },
