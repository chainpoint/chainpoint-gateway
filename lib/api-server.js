...
async function startAsync () {
  ...
  // submit hash(es)
  server.post({ path: '/hashes', version: '1.0.0' }, ensureInSync, ensureAcceptingHashes, apiHashes.postHashesV1Async)
  ...
  server.get({ path: '/calendar/:height/hash', version: '1.0.0' }, ensureInSync, apiCalendar.getCalBlockHashByHeightV1Async)
  // get the block data value for the calendar at the specified height
  server.get({ path: '/calendar/:height/data', version: '1.0.0' }, ensureInSync, apiCalendar.getCalBlockDataByHeightV1Async)
