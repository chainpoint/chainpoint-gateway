...
async function startAsync () {
  let torExitNodeIPs = await initTorExitAsync()

  torExitNodeIPs.push('127.0.0.1')
  // Uncomment and modify to reflect local Docker IP for testing.
  // tenIPs.push('::ffff:172.18.0.1')
