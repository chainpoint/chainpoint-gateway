...
let AGG_FOR_CORE_INTERVAL_MS = 5000
...
async function addHashDataAsync (hashArray, sourceIp) {
  await redis.saddAsync(env.HASH_DATA_KEY, JSON.stringify({ hashes: hashArray, sourceIp: sourceIp }))
}
