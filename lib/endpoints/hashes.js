...
async function postHashesV1Async (req, res, next) {
  ...
  // Persist hashIdNode to a capped redis list for the Node Stats UI -> nodestats:last25HashIds
  for (let hashObj of responseObj.hashes) {
    eventMetrics.logRecentHash(hashObj.hashIdNode, hashObj.hash, responseObj.meta.submitted_at)
  }
