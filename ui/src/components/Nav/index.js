        ...
        <div className='chp-navbar'>
          <Grid fluid>
            <Row>
              <Col xs={12}>
                <Col xs={9}>
                  <img onClick={() => this.props.history.push('/')} className='nav-logo add-top-padding cursor' src={`${process.env.PUBLIC_URL}/images/chainpoint_logo@2x.png`} alt='Chainpoint' />&nbsp;&nbsp;&nbsp;&nbsp;<span style={{color: '#757575', position: 'relative', top: '22px'}}>PREVIEW&nbsp;RELEASE</span>
                </Col>
                <Col xs={3}>
