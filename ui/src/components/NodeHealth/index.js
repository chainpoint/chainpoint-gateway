  ...
  render() {
    ...
    return (
      <Col xs={12}>
        <Col
          xs={12}
          className={classnames('tile', 'node-health-tile', 'center-align', {
        ...
        >
          <span className="health-icon">
            {health.healthIcon && (
              <FontAwesome name={health.healthIcon} size="5x" />
            )}
            <h4 className="add-top no-margin-bottom no-padding-bottom">
              {health.healthLabel}
            </h4>
          </span>
        </Col>
