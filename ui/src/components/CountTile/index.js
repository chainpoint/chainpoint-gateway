  ...
  render() {
    return (
      <Col
        xs={12}
        sm={this.props.size}
        className={classnames('add-top', this.props.extraClasses)}
      >
        <Col
          xs={12}
          ...
          className={classnames(
            ...
            this.props.txtcolor && `${this.props.txtcolor}-text`
          )}
        >
          <div>
            ...
            {this.props.count === null ? (
              <FontAwesome
                className="tierion-tealblue-text"
                name="gear"
                spin
                size="4x"
              />
              ...
              <NumberFormat
                ...
                thousandSeparator
                renderText={value => (
                  <span className="count tierion-tealblue-text">{value}</span>
                )}
              />
            )}
